...
- 当前 tighter H2 hardware probe 已从 `44 shots / target_precision 0.15` 推进到 `1024 shots / requested_precision 0.05 / runtime_usage≈12s`，runtime-derived `achieved_error` 下降到约 `0.174 Ha`；这说明 budget-aware runtime calibration 已经在工作，但仍未达到 chemical-accuracy 级别。
