"""Exploratory folded-spectrum skeleton."""
...
class ExploratoryFoldedSpectrumSolver(BaseSolver):
    """Exploratory folded-spectrum skeleton delegating to QCchem VQE."""
        ...
        metadata.update(
            {
                ...
                "validation_scope": "folded_spectrum skeleton",
                "scientific_risk_notes": [
                    "Current folded-spectrum path delegates to QCchem VQE and does not validate interior-state targeting.",
                ],
...
def build_solver(spec, backend, seed, problem_summary=None, mapper=None) -> BaseSolver:
    ...
    return ExploratoryFoldedSpectrumSolver(delegate)
