...
- runtime_job_id: `d7qpl6cf3ras73b64hsg`

## Evidence Summary

- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'job_02_jw_puccd_layout_baseline_8192', 'molecule_name': 'H2-hardware-precision-push', 'basis': 'sto3g', 'backend_kind': 'statevector', 'mapping_kind': 'jordan_wigner'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 4.775011497315518e-10, 'units': 'Hartree', 'threshold': 0.0016, 'comparison_target': 'variational_result'}`
...
- comparison_evidence: `{'comparison_target': 'variational_result', 'absolute_error': 4.775011497315518e-10, 'relative_error': 2.5777596539682023e-10, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 98.5239898750151, 'shots': None, 'measurement_strategy': 'hardware_precision_push', 'measurement_group_count': 5, 'measured_shot_usage': None, 'runtime_backend': 'ibm_kingston', 'runtime_job_id': 'd7qpl6cf3ras73b64hsg'}`
...
- provenance_timestamp: `2026-05-02T06:32:57.364220+00:00`
- runtime_job_id: `d7qpl6cf3ras73b64hsg`
- artifact_root: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192`
...
- job_id: `d7qpl6cf3ras73b64hsg`
- verification_status: `exploratory`
- layout_strategy: `min_weighted_error`
- selected_layout: `[109, 108, 107, 97]`
...
- absolute_error_hartree: `0.047700898475` Hartree
- absolute_error_kcal_mol: `29.9327657114017`
- threshold_hartree: `0.0016`
- threshold_kcal_mol: `1.0040151583999999`
- statistical_error: `0.007588620405` Hartree
...
- available: `True`
- measured_wall_time_seconds: `0.3297186249983497`
...
- layout_strategy: `min_weighted_error`
- selected_layout: `[109, 108, 107, 97]`
- layout_score: `0.009055889890685592`
- transpiled_depth: `149`
- transpiled_two_qubit_gate_count: `42`
- transpilation_options: `{'approximation_degree': 1.0, 'initial_layout': [109, 108, 107, 97], 'layout_method': 'sabre', 'optimization_level': 3, 'routing_method': 'sabre', 'seed_transpiler': 1729}`
- job_id: `d7qpl6cf3ras73b64hsg`
- session_id: `None`
- batch_id: `None`
- submission_wall_time_seconds: `97.94168395802262`
- usage_estimation: `{'quantum_seconds': 45.164042271}`
- job_metrics: `{'caller': 'qiskit_ibm_runtime~estimator.py', 'qiskit_version': 'qiskit_ibm_runtime-0.46.1,qiskit-2.3.0*,qiskit_aer-0.17.2*,qiskit_nature-0.7.2*', 'timestamps': {'created': '2026-05-02T06:32:57.507579Z', 'finished': '2026-05-02T06:33:52.925806Z', 'running': '2026-05-02T06:32:58.77627Z'}, 'bss': {'seconds': 45}, 'usage': {'quantum_seconds': 45, 'seconds': 45}}`
...
- returned_job_metadata: `{'evs': [-1.8046872750945395], 'stds': [0.007588620404836616], 'metadata': {'shots': 8192, 'target_precision': 0.011048543456039804, 'circuit_metadata': {}, 'resilience': {'zne': {'extrapolator': ['multiple']}}, 'num_randomizations': 32}}`
- result_provenance: `{'attempt_stage': 'result_retrieved', 'backend_name': 'ibm_kingston', 'backend_selection_strategy': 'min_weighted_error', 'candidates': [{'backend_name': 'ibm_kingston', 'entangling_score': 0.003928936765685592, 'layout_score': 0.009055889890685592, 'pending_jobs': 0, 'readout_score': 0.0205078125, 'selected_layout': [109, 108, 107, 97]}, {'backend_name': 'ibm_marrakesh', 'entangling_score': 0.004927266902349209, 'layout_score': 0.010603536433599209, 'pending_jobs': 0, 'readout_score': 0.022705078125, 'selected_layout': [2, 1, 3, 4]}, {'backend_name': 'ibm_fez', 'entangling_score': 0.005506442005316664, 'layout_score': 0.015241549427191664, 'pending_jobs': 1, 'readout_score': 0.0389404296875, 'selected_layout': [136, 143, 142, 141]}], 'circuit_qubits': 4, 'last_polled_at': '2026-05-02T06:36:59.360185+00:00', 'last_polled_status': 'DONE', 'layout_strategy': 'min_weighted_error', 'operator_qubits': 4, 'parameter_count': 1, 'runtime_package_version': '0.46.1', 'selected_backend': 'ibm_kingston'}`
...
- Timestamp: `2026-05-02T06:32:57.364220+00:00`
- Wall time (s): `98.5239898750151`
...
- Workspace fingerprint: `f23179db25673a4b619dfb6d44af86419c20b90feeb631c31551569de977e607`
...
- result.json: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/result.json`
- exact_result.json: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/exact_result.json`
- report.md: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/report.md`
- resolved_config.yaml: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/resolved_config.yaml`
- run.log: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/run.log`
- calibration.json: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/calibration.json`
- calibration_report.md: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/calibration_report.md`
- runtime_submission.json: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/runtime_submission.json`
- qcschema.json: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/qcschema.json`
- result.h5: `/Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/result.h5`
...
- Writing exact baseline artifact to /Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/exact_result.json
- Computed empirical calibration: wall_time=0.330s, measured_cost=None
- Persisted runtime submission sidecar after job submit: d7qpl6cf3ras73b64hsg
- Runtime submission attempt recorded: submitted
- Writing JSON result to /Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/result.json
- Writing Markdown report to /Users/a0000/QCchem/artifacts/h2_hardware_precision_push/runtime_jobs/job_02_jw_puccd_layout_baseline_8192/report.md
- Run completed
