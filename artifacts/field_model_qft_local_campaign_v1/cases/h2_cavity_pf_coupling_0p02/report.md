...
- headline_total_energy: `-1.137407578585` Hartree
- headline_correlation_energy: `-0.020648271189` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_cavity_pf_coupling_0p02', 'molecule_name': 'H2-cavity-PF-exact', 'basis': 'sto3g', 'backend_kind': 'statevector', 'mapping_kind': 'pauli_fierz_cavity_qed:jordan_wigner+bosonic_linear', 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 2.220446049250313e-16, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 2.220446049250313e-16, 'relative_error': 1.198613638096181e-16, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.08401625003898516, 'shots': None, 'measurement_strategy': 'cavity_qed_exact', 'measurement_group_count': 9, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- provenance_timestamp: `2026-05-15T13:03:21.422532+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02`
...
- electronic_energy: `-1.852511917666` Hartree
- nuclear_repulsion_energy: `0.715104339081` Hartree
- total_energy: `-1.137407578585` Hartree
- hf_reference_energy: `-1.116759307396` Hartree
- solver_energy: `-1.852511917666` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.852511917666` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `-0.020648271189` Hartree
...
- solver_hamiltonian_energy: `-1.852511917666` Hartree
- electronic_energy: `-1.852511917666` Hartree
- total_energy: `-1.137407578585` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-1.852511917666` Hartree
- exact_total_energy: `-1.137407578585` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `1.198613638096181e-16`
- statistical_error: `None`
...
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 9.972629004001523e-15, 'vqe_vs_exact_error': 2.220446049250313e-16, 'photon_encoding_leakage': 1.3216535838412596e-31}`
...
- mode_count: `1`
- modes: `[{'mode_index': 0, 'frequency': 0.4, 'coupling_strength': 0.02, 'polarization': [0.0, 0.0, 1.0], 'max_occupation': 1, 'mode_qubits': 2}]`
...
- photon occupation: `[{'mode_index': 0, 'expectation': 0.00028663373276439235}]`
- dipole_expectation: `[{'mode_index': 0, 'expectation': -2.1902354536774166e-09}]`
- electron_photon_coupling_energy: `[{'mode_index': 0, 'expectation': -0.0007852319034248321}]`
- dipole_self_energy: `[{'mode_index': 0, 'expectation': 0.0002690910014069241}]`
- polaritonic_state_composition: `[{'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 0, 'max_occupation': 1, 'weight': 0.9997133662672366}, {'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 1, 'max_occupation': 1, 'weight': 0.00028663373276439235}, {'component': 'exact_ground_state_photon_marginal', 'mode_index': 0, 'mean_photon_occupation': 0.00028663373276439235}]`
- photon_physical_subspace_leakage: `1.3216535838412596e-31`
- exact_residual_norm: `9.972629004001523e-15`
- vqe_vs_exact_error: `2.220446049250313e-16`
- resource_estimate: `{'electronic_qubits': 4, 'photon_qubits': 2, 'total_qubits': 6, 'pauli_terms': 44, 'mode_qubits': [2]}`
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 9.972629004001523e-15, 'vqe_vs_exact_error': 2.220446049250313e-16, 'photon_encoding_leakage': 1.3216535838412596e-31}`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `1.393350932410442e-13`
- threshold_hartree: `0.0016`
...
- available: `True`
- measured_wall_time_seconds: `0.0012138750171288848`
...
- Timestamp: `2026-05-15T13:03:21.422532+00:00`
- Wall time (s): `0.08401625003898516`
...
- Workspace fingerprint: `0f8bc6f94faa702f5002907f9a2e6b9b6cfefdf4c06cd832c92833f10c9a9ad5`
...
- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/exact_result.json
- Computed empirical calibration: wall_time=0.001s, measured_cost=None
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p02/report.md
- Run completed
