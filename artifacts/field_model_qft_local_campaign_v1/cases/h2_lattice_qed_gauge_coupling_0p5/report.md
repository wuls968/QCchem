...
- headline_total_energy: `-8.638257629341` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_gauge_coupling_0p5', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 2.842170943040401e-14, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 2.842170943040401e-14, 'relative_error': 2.882566973754774e-15, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.09441508300369605, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-15T13:03:17.490665+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5`
...
- electronic_energy: `-9.859860911881` Hartree
- nuclear_repulsion_energy: `1.221603282540` Hartree
- total_energy: `-8.638257629341` Hartree
- hf_reference_energy: `None`
- solver_energy: `-9.859860911881` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-9.859860911881` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
...
- solver_hamiltonian_energy: `-9.859860911881` Hartree
- electronic_energy: `-9.859860911881` Hartree
- total_energy: `-8.638257629341` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-9.859860911881` Hartree
- exact_total_energy: `-8.638257629341` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `2.882566973754774e-15`
- statistical_error: `None`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `1.7834891934853657e-11`
- threshold_hartree: `0.0016`
...
- available: `True`
- measured_wall_time_seconds: `0.0048817500355653465`
...
- Timestamp: `2026-05-15T13:03:17.490665+00:00`
- Wall time (s): `0.09441508300369605`
...
- Workspace fingerprint: `9ca7e0fd33e2245af92134b2c6bd9cfe2ba25e795c29e6d0950a777df9fa47ef`
...
- Seed: `2026`
- Source config: `/Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_lattice_qed_exact.yaml`

## Artifacts

- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`

## Log Summary

- Loading config from /Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_lattice_qed_exact.yaml
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/exact_result.json
- Computed empirical calibration: wall_time=0.005s, measured_cost=None
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_gauge_coupling_0p5/report.md
- Run completed
