# QCchem Report: H2-4site-lattice-QED-sparse-dynamics
...
- molecule: `H2-4site-lattice-QED-sparse-dynamics`
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_4site_sparse_dynamics', 'molecule_name': 'H2-4site-lattice-QED-sparse-dynamics', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
- primary_scientific_claim: `H2-4site-lattice-QED-sparse-dynamics lattice-QED result is gauge-audited finite-cutoff evidence compared against variational_result.`
...
- execution_evidence: `{'wall_time_seconds': 0.43915962503524497, 'shots': None, 'measurement_strategy': 'lattice_qed_sparse_dynamics', 'measurement_group_count': 1, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
- trust_judgment: `{'verification_status': 'exploratory', 'module_origin': 'exploratory', 'hardware_verified': False, 'hardware_evidence_tier': None, 'verification_notes': ['validation_scope=lattice_qed_sparse_projected_exact', 'validation_scope=lattice_qed_finite_cutoff_exact_gate', 'validation_scope=lattice_qed_real_time_dynamics'], 'scientific_risk_notes': ['Sparse exact energy is exact only for the configured finite lattice/cutoff Hamiltonian.', 'Physical-sector projection is a finite-cutoff Gauss-law audit, not continuum chemistry accuracy.', 'Lattice-QED execution uses a finite cutoff real-space field Hamiltonian.', 'Exact baselines compare against the discretized finite cutoff model, not continuum chemistry.', 'Continuum, gauge-cutoff, and grid-convergence claims require explicit follow-up studies.', 'Exploratory finite-cutoff compact-U(1) lattice-QED Hamiltonian.', 'Sparse/projected engine is an internal finite-cutoff representation, not continuum chemistry.', 'Runtime circuits still act on the full qubit register unless explicitly transformed.', 'QFT dynamics curves are exact/Trotter trajectories of the finite lattice/cutoff Hamiltonian.', 'Trotter and runtime-batch evidence do not establish continuum-limit molecular accuracy.']}`
- provenance_timestamp: `2026-05-15T13:03:17.174989+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics`
...
- Verification Notes: `['validation_scope=lattice_qed_sparse_projected_exact', 'validation_scope=lattice_qed_finite_cutoff_exact_gate', 'validation_scope=lattice_qed_real_time_dynamics']`
...
- quench: `{'kind': 'local_hopping_pulse', 'base': 'physical_reference', 'reference_basis_index': 218, 'evolution_reference_index': 0, 'link_index': 0, 'pulse_time': 0.05, 'pulse_strength': 1.0, 'post_pulse_state_norm': 1.0}`
- time_grid: `{'start': 0.0, 'stop': 1.0, 'num_points': 21}`
- observable_summary: `{'site_density_count': 4, 'link_electric_flux_count': 3, 'link_electric_energy_count': 3, 'gauss_residual_count': 4, 'plaquette_wilson_count': 0, 'aggregate_observables': ['particle_number', 'total_electric_energy', 'total_gauss_violation', 'total_wilson']}`
- exact_available: `True`
- exact_time_point_count: `21`
- exact_skipped_reason: `None`
- trotter_available: `True`
- trotter_circuit_resources: `{'time_point_count': 21, 'max_depth': 62, 'max_operation_count': 66, 'max_two_qubit_gate_count': 0, 'per_time_point': [{'time': 0.0, 'depth': 2, 'operation_count': 6, 'two_qubit_gate_count': 0}, {'time': 0.05, 'depth': 5, 'operation_count': 9, 'two_qubit_gate_count': 0}, {'time': 0.1, 'depth': 8, 'operation_count': 12, 'two_qubit_gate_count': 0}, {'time': 0.15000000000000002, 'depth': 14, 'operation_count': 18, 'two_qubit_gate_count': 0}, {'time': 0.2, 'depth': 14, 'operation_count': 18, 'two_qubit_gate_count': 0}, {'time': 0.25, 'depth': 17, 'operation_count': 21, 'two_qubit_gate_count': 0}, {'time': 0.30000000000000004, 'depth': 23, 'operation_count': 27, 'two_qubit_gate_count': 0}, {'time': 0.35000000000000003, 'depth': 23, 'operation_count': 27, 'two_qubit_gate_count': 0}, {'time': 0.4, 'depth': 26, 'operation_count': 30, 'two_qubit_gate_count': 0}, {'time': 0.45, 'depth': 29, 'operation_count': 33, 'two_qubit_gate_count': 0}, {'time': 0.5, 'depth': 32, 'operation_count': 36, 'two_qubit_gate_count': 0}, {'time': 0.55, 'depth': 35, 'operation_count': 39, 'two_qubit_gate_count': 0}, {'time': 0.6000000000000001, 'depth': 41, 'operation_count': 45, 'two_qubit_gate_count': 0}, {'time': 0.65, 'depth': 41, 'operation_count': 45, 'two_qubit_gate_count': 0}, {'time': 0.7000000000000001, 'depth': 44, 'operation_count': 48, 'two_qubit_gate_count': 0}, {'time': 0.75, 'depth': 47, 'operation_count': 51, 'two_qubit_gate_count': 0}, {'time': 0.8, 'depth': 50, 'operation_count': 54, 'two_qubit_gate_count': 0}, {'time': 0.8500000000000001, 'depth': 53, 'operation_count': 57, 'two_qubit_gate_count': 0}, {'time': 0.9, 'depth': 56, 'operation_count': 60, 'two_qubit_gate_count': 0}, {'time': 0.9500000000000001, 'depth': 59, 'operation_count': 63, 'two_qubit_gate_count': 0}, {'time': 1.0, 'depth': 62, 'operation_count': 66, 'two_qubit_gate_count': 0}], 'trotter_step': 0.05, 'trotter_order': 1}`
- trotter_error_summary: `{'available': True, 'max_loschmidt_abs_error': 8.725132289133519e-05, 'max_particle_number_abs_error': 8.881784197001252e-16, 'max_total_gauss_violation_abs_error': 0.0}`
- runtime_batch: `{}`
...
- notes: `["Measurement groups estimated with strategy 'lattice_qed_sparse_dynamics'.", 'Per-group shot estimate derived from precision target 0.01.', 'Measurement planning reflects the uncompressed execution path.']`
...
- available: `True`
- measured_wall_time_seconds: `0.00030162499751895666`
...
- Timestamp: `2026-05-15T13:03:17.174989+00:00`
- Wall time (s): `0.43915962503524497`
...
- Workspace fingerprint: `1f384e77cecbc8e53807e867825c37fa1437fb4ddb77693a48a70276c0b21cf6`
...
- Seed: `2042`
- Source config: `/Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_4site_lattice_qed_sparse_dynamics.yaml`

## Artifacts

- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`

## Log Summary

- Loading config from /Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_4site_lattice_qed_sparse_dynamics.yaml
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/exact_result.json
...
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_lattice_qed_4site_sparse_dynamics/report.md
- Run completed
