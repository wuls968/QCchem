...
- headline_total_energy: `-1.138050069526` Hartree
- headline_correlation_energy: `-0.021290762129` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_cavity_pf_coupling_0p05', 'molecule_name': 'H2-cavity-PF-exact', 'basis': 'sto3g', 'backend_kind': 'statevector', 'mapping_kind': 'pauli_fierz_cavity_qed:jordan_wigner+bosonic_linear', 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 3.1086244689504383e-15, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 3.1086244689504383e-15, 'relative_error': 1.6774773081576898e-15, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.10077433299738914, 'shots': None, 'measurement_strategy': 'cavity_qed_exact', 'measurement_group_count': 9, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- provenance_timestamp: `2026-05-15T13:03:21.526615+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05`
...
- electronic_energy: `-1.853154408607` Hartree
- nuclear_repulsion_energy: `0.715104339081` Hartree
- total_energy: `-1.138050069526` Hartree
- hf_reference_energy: `-1.116759307396` Hartree
- solver_energy: `-1.853154408607` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.853154408607` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `-0.021290762129` Hartree
...
- solver_hamiltonian_energy: `-1.853154408607` Hartree
- electronic_energy: `-1.853154408607` Hartree
- total_energy: `-1.138050069526` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-1.853154408607` Hartree
- exact_total_energy: `-1.138050069526` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `1.6774773081576898e-15`
- statistical_error: `None`
...
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.5723098884654748e-14, 'vqe_vs_exact_error': 3.1086244689504383e-15, 'photon_encoding_leakage': 3.5378467739645574e-31}`
...
- mode_count: `1`
- modes: `[{'mode_index': 0, 'frequency': 0.4, 'coupling_strength': 0.05, 'polarization': [0.0, 0.0, 1.0], 'max_occupation': 1, 'mode_qubits': 2}]`
...
- term_counts_by_sector: `{'electronic': 15, 'photon': 4, 'electron_photon_coupling': 18, 'dipole_self_energy': 23, 'photon_physical_subspace_penalty': 2, 'total': 48}`
- photon occupation: `[{'mode_index': 0, 'expectation': 0.00177988044182386}]`
- dipole_expectation: `[{'mode_index': 0, 'expectation': -2.238187697745806e-09}]`
- electron_photon_coupling_energy: `[{'mode_index': 0, 'expectation': -0.004891208678263577}]`
- dipole_self_energy: `[{'mode_index': 0, 'expectation': 0.0016878698827522368}]`
- polaritonic_state_composition: `[{'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 0, 'max_occupation': 1, 'weight': 0.9982201195581767}, {'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 1, 'max_occupation': 1, 'weight': 0.0017798804418238602}, {'component': 'exact_ground_state_photon_marginal', 'mode_index': 0, 'mean_photon_occupation': 0.00177988044182386}]`
- photon_physical_subspace_leakage: `3.5378467739645574e-31`
- exact_residual_norm: `1.5723098884654748e-14`
- vqe_vs_exact_error: `3.1086244689504383e-15`
- resource_estimate: `{'electronic_qubits': 4, 'photon_qubits': 2, 'total_qubits': 6, 'pauli_terms': 48, 'mode_qubits': [2]}`
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.5723098884654748e-14, 'vqe_vs_exact_error': 3.1086244689504383e-15, 'photon_encoding_leakage': 3.5378467739645574e-31}`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `1.9506913053746185e-12`
- threshold_hartree: `0.0016`
...
- available: `True`
- measured_wall_time_seconds: `0.0012279169750399888`
...
- Timestamp: `2026-05-15T13:03:21.526615+00:00`
- Wall time (s): `0.10077433299738914`
...
- Workspace fingerprint: `757de01f1dda739761183d565553233d6eb2444928d35d52fbcd2879ea0fad93`
...
- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/exact_result.json
- Computed empirical calibration: wall_time=0.001s, measured_cost=None
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_coupling_0p05/report.md
- Run completed
