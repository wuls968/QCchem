# QCchem Report: H2-cavity-PF-VQE
...
- molecule: `H2-cavity-PF-VQE`
- basis: `sto3g`
- method: `vqe / {'kind': 'cavity_twolocal', 'rotation_blocks': ['ry', 'rz'], 'entanglement_blocks': 'cz', 'entanglement': 'linear', 'reps': 1}`
- mapping_kind: `pauli_fierz_cavity_qed:jordan_wigner+bosonic_linear`
- num_qubits: `6`
- verification_status: `exploratory`
- hardware_verified: `False`
- hardware_evidence_tier: `None`
- benchmark_absolute_error: `0.022402375129` Hartree
- best_available_assessment: `local_execution`
- backend_kind: `statevector`

## Hero

- headline_total_energy: `-1.115373811259` Hartree
- headline_correlation_energy: `0.001385496137` Hartree
- headline_absolute_error: `0.022402375129` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_cavity_pf_vqe_cutoff_1', 'molecule_name': 'H2-cavity-PF-VQE', 'basis': 'sto3g', 'backend_kind': 'statevector', 'mapping_kind': 'pauli_fierz_cavity_qed:jordan_wigner+bosonic_linear', 'field_model_kind': 'pauli_fierz_cavity_qed'}`
- primary_scientific_claim: `H2-cavity-PF-VQE Pauli-Fierz cavity-QED result uses a finite photon cutoff and is compared against variational_result within the configured electron-photon Hamiltonian.`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 0.02240237512891996, 'units': 'Hartree', 'threshold': 1.0, 'comparison_target': 'variational_result'}`
...
- comparison_evidence: `{'comparison_target': 'variational_result', 'absolute_error': 0.02240237512891996, 'relative_error': 0.012090566456381712, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.17087087500840425, 'shots': None, 'measurement_strategy': 'cavity_qed_vqe', 'measurement_group_count': 9, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- provenance_timestamp: `2026-05-15T13:03:21.246077+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1`
...
- absolute_error_hartree: `0.022402375129` Hartree
- threshold_hartree: `0.0016`
- distance_to_chemical_accuracy: `0.02080237512891996`
...
- electronic_energy: `-1.830478150340` Hartree
- nuclear_repulsion_energy: `0.715104339081` Hartree
- total_energy: `-1.115373811259` Hartree
- hf_reference_energy: `-1.116759307396` Hartree
- solver_energy: `-1.830478150340` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.852880525469` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `0.001385496137` Hartree
...
- absolute_error: `0.022402375129` Hartree
- relative_error: `0.012090566456381712`
- statistical_error: `None`
...
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.0537429488356753e-14, 'vqe_vs_exact_error': 0.02240237512891996, 'photon_encoding_leakage': 1.022001840317077e-31}`
...
- photon occupation: `[{'mode_index': 0, 'expectation': 0.0011422899425083703}]`
- dipole_expectation: `[{'mode_index': 0, 'expectation': -2.2265079124634704e-09}]`
- electron_photon_coupling_energy: `[{'mode_index': 0, 'expectation': -0.0031348885143326374}]`
- dipole_self_energy: `[{'mode_index': 0, 'expectation': 0.0010785846635300773}]`
- polaritonic_state_composition: `[{'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 0, 'max_occupation': 1, 'weight': 0.998857710057491}, {'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 1, 'max_occupation': 1, 'weight': 0.0011422899425083703}, {'component': 'exact_ground_state_photon_marginal', 'mode_index': 0, 'mean_photon_occupation': 0.0011422899425083703}]`
- photon_physical_subspace_leakage: `1.022001840317077e-31`
- exact_residual_norm: `1.0537429488356753e-14`
- vqe_vs_exact_error: `0.02240237512891996`
- resource_estimate: `{'electronic_qubits': 4, 'photon_qubits': 2, 'total_qubits': 6, 'pauli_terms': 44, 'mode_qubits': [2]}`
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [1], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.0537429488356753e-14, 'vqe_vs_exact_error': 0.02240237512891996, 'photon_encoding_leakage': 1.022001840317077e-31}`
...
- meets_chemical_accuracy: `False`
- absolute_error_hartree: `0.022402375129` Hartree
- absolute_error_kcal_mol: `14.057702633499245`
- threshold_hartree: `0.0016`
...
- notes: `["Measurement groups estimated with strategy 'cavity_qed_vqe'.", 'Per-group shot estimate derived from precision target 0.01.', 'Measurement planning reflects the uncompressed execution path.']`
...
- available: `True`
- measured_wall_time_seconds: `0.0871792079997249`
- measured_shot_usage: `None`
- precision_target: `0.01`
- achieved_error: `0.022402375129` Hartree
...
- ansatz: `{'kind': 'cavity_twolocal', 'rotation_blocks': ['ry', 'rz'], 'entanglement_blocks': 'cz', 'entanglement': 'linear', 'reps': 1}`
- initial_point_strategy: `zeros`
- parameter_count: `24`
- converged: `False`
- iterations: `60`
- evaluations: `60`
- final_objective_energy: `-1.830478150340` Hartree
...
- Timestamp: `2026-05-15T13:03:21.246077+00:00`
- Wall time (s): `0.17087087500840425`
...
- Workspace fingerprint: `270d70312825498c2eb4c230bc15b5008d10425d303f4c2e96c3eac0ceb578ee`
...
- Seed: `2142`
- Source config: `/Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_cavity_pf_vqe.yaml`

## Artifacts

- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`

## Log Summary

- Loading config from /Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_cavity_pf_vqe.yaml
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/exact_result.json
- Computed empirical calibration: wall_time=0.087s, measured_cost=None
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_vqe_cutoff_1/report.md
- Run completed
