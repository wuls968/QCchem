# QCchem Report: H2-cavity-PF-cutoff-2
...
- molecule: `H2-cavity-PF-cutoff-2`
- basis: `sto3g`
- method: `statevector`
...
- headline_total_energy: `-1.137785562317` Hartree
- headline_correlation_energy: `-0.021026254920` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_cavity_pf_exact_cutoff_2', 'molecule_name': 'H2-cavity-PF-cutoff-2', 'basis': 'sto3g', 'backend_kind': 'statevector', 'mapping_kind': 'pauli_fierz_cavity_qed:jordan_wigner+bosonic_linear', 'field_model_kind': 'pauli_fierz_cavity_qed'}`
- primary_scientific_claim: `H2-cavity-PF-cutoff-2 Pauli-Fierz cavity-QED result uses a finite photon cutoff and is compared against exact_baseline within the configured electron-photon Hamiltonian.`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 1.9761969838327786e-14, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 1.9761969838327786e-14, 'relative_error': 1.066548520957388e-14, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.09035937499720603, 'shots': None, 'measurement_strategy': 'cavity_qed_exact_cutoff_2', 'measurement_group_count': 9, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'pauli_fierz_cavity_qed'}`
...
- provenance_timestamp: `2026-05-15T13:03:21.071285+00:00`
- runtime_job_id: `None`
- artifact_root: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2`
...
- electronic_energy: `-1.852889901398` Hartree
- nuclear_repulsion_energy: `0.715104339081` Hartree
- total_energy: `-1.137785562317` Hartree
- hf_reference_energy: `-1.116759307396` Hartree
- solver_energy: `-1.852889901398` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.852889901398` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `-0.021026254920` Hartree
...
- solver_hamiltonian_energy: `-1.852889901398` Hartree
- electronic_energy: `-1.852889901398` Hartree
- total_energy: `-1.137785562317` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-1.852889901398` Hartree
- exact_total_energy: `-1.137785562317` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `1.066548520957388e-14`
- statistical_error: `None`
...
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [2], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.3711030439130465e-14, 'vqe_vs_exact_error': 1.9761969838327786e-14, 'photon_encoding_leakage': 1.1359335436452865e-31}`
...
- mode_count: `1`
- modes: `[{'mode_index': 0, 'frequency': 0.4, 'coupling_strength': 0.04, 'polarization': [0.0, 0.0, 1.0], 'max_occupation': 2, 'mode_qubits': 3}]`
...
- term_counts_by_sector: `{'electronic': 15, 'photon': 7, 'electron_photon_coupling': 36, 'dipole_self_energy': 19, 'photon_physical_subspace_penalty': 7, 'total': 65}`
- photon occupation: `[{'mode_index': 0, 'expectation': 0.0011740991335326984}]`
- dipole_expectation: `[{'mode_index': 0, 'expectation': -2.2273672569152637e-09}]`
- electron_photon_coupling_energy: `[{'mode_index': 0, 'expectation': -0.0031724681699303913}]`
- dipole_self_energy: `[{'mode_index': 0, 'expectation': 0.0010786369217246233}]`
- polaritonic_state_composition: `[{'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 0, 'max_occupation': 2, 'weight': 0.9988349627781982}, {'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 1, 'max_occupation': 2, 'weight': 0.0011559753100669464}, {'component': 'electronic_marginal_x_photon_occupation', 'mode_index': 0, 'occupation': 2, 'max_occupation': 2, 'weight': 9.061911732986956e-06}, {'component': 'exact_ground_state_photon_marginal', 'mode_index': 0, 'mean_photon_occupation': 0.0011740991335326984}]`
- photon_physical_subspace_leakage: `1.1359335436452865e-31`
- exact_residual_norm: `1.3711030439130465e-14`
- vqe_vs_exact_error: `1.9761969838327786e-14`
- resource_estimate: `{'electronic_qubits': 4, 'photon_qubits': 3, 'total_qubits': 7, 'pauli_terms': 65, 'mode_qubits': [3]}`
- error_budget: `{'photon_cutoff': {'max_occupation_by_mode': [2], 'status': 'finite_cutoff_configured'}, 'exact_residual_norm': 1.3711030439130465e-14, 'vqe_vs_exact_error': 1.9761969838327786e-14, 'photon_encoding_leakage': 1.1359335436452865e-31}`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `1.2400823298452934e-11`
- threshold_hartree: `0.0016`
...
- strategy: `cavity_qed_exact_cutoff_2`
...
- notes: `["Measurement groups estimated with strategy 'cavity_qed_exact_cutoff_2'.", 'Per-group shot estimate derived from precision target 0.01.', 'Measurement planning reflects the uncompressed execution path.']`
...
- available: `True`
- measured_wall_time_seconds: `0.0022747499751858413`
...
- Timestamp: `2026-05-15T13:03:21.071285+00:00`
- Wall time (s): `0.09035937499720603`
...
- Workspace fingerprint: `a3dd06f5f898454d2fb46652205d3dd7e7285729031b2970342511888679fda5`
...
- Seed: `2143`
- Source config: `/Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_cavity_pf_cutoff_convergence.yaml`

## Artifacts

- result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/result.json`
- exact_result.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/exact_result.json`
- report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/report.md`
- resolved_config.yaml: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/resolved_config.yaml`
- run.log: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/run.log`
- calibration.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/calibration.json`
- calibration_report.md: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/calibration_report.md`
- runtime_submission.json: `/Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/runtime_submission.json`
- qcschema.json: `None`
- result.h5: `None`

## Log Summary

- Loading config from /Users/a0000/.codex/worktrees/c397/QCchem/configs/exploratory/h2_cavity_pf_cutoff_convergence.yaml
...
- Constructed cavity-QED Hamiltonian: modes=1, electronic_qubits=4, photon_qubits=3
...
- Writing exact baseline artifact to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/exact_result.json
- Computed empirical calibration: wall_time=0.002s, measured_cost=None
- Writing JSON result to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/result.json
- Writing Markdown report to /Users/a0000/.codex/worktrees/c397/QCchem/artifacts/field_model_qft_local_campaign_v1/cases/h2_cavity_pf_exact_cutoff_2/report.md
- Run completed
