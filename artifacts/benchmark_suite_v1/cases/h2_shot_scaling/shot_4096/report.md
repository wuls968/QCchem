...
- electronic_energy: `-1.856370228951` Hartree
- nuclear_repulsion_energy: `0.719968994449` Hartree
- total_energy: `-1.136401234502` Hartree
- hf_reference_energy: `-1.116998996754` Hartree
- solver_energy: `-1.856370228951` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.857275030202` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `-0.019402237748` Hartree
...
- absolute_error: `0.008267435610` Hartree
- relative_error: `0.004451379292789543`
- statistical_error: `0.000943297659` Hartree
...
- iterations: `34`
- evaluations: `34`
- final_objective_energy: `-1.856370228951` Hartree
...
- sampled_solver_energy_mean: `-1.849007594592` Hartree
- sampled_solver_energy_std: `0.002109277689` Hartree
- sampled_electronic_energy_mean: `-1.849007594592` Hartree
- sampled_total_energy_mean: `-1.129038600143` Hartree
- standard_error: `0.000943297659` Hartree
- confidence_interval_low: `-1.850856458004` Hartree
- confidence_interval_high: `-1.847158731180` Hartree
...
- Timestamp: `2026-04-11T06:58:41.119727+00:00`
- Wall time (s): `1.9104923339982633`
- Git commit: `None`
...
- result.json: `/Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/result.json`
- exact_result.json: `/Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/exact_result.json`
- report.md: `/Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/report.md`
- resolved_config.yaml: `/Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/resolved_config.yaml`
- run.log: `/Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/run.log`
...
- Writing exact baseline artifact to /Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/exact_result.json
- Collected repeated shot-based sampling statistics
- Writing JSON result to /Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/result.json
- Writing Markdown report to /Users/a0000/QCchem/artifacts/benchmark_suite_v1/cases/h2_shot_scaling/shot_4096/report.md
- Run completed
