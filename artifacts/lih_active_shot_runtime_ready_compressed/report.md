...
- electronic_energy: `-8.856317746968` Hartree
- nuclear_repulsion_energy: `0.992207270475` Hartree
- total_energy: `-7.864110476493` Hartree
- hf_reference_energy: `-7.861864769809` Hartree
- solver_energy: `-1.060098178191` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-1.059126320696` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
- correlation_energy: `-0.002245706685` Hartree
...
- absolute_error: `0.001093321739` Hartree
- relative_error: `0.0001390460833319672`
- statistical_error: `0.000122647265` Hartree
...
- pre_term_count: `27`
- post_term_count: `12`
- compressed_solver_energy: `-1.060098178191` Hartree
- uncompressed_solver_energy: `-1.059004856453` Hartree
- compressed_total_energy: `-7.864110476493` Hartree
- uncompressed_total_energy: `-7.863017154755` Hartree
- absolute_error: `0.001093321739` Hartree
- relative_error: `0.0001390460833319672`
- compressed_solve_wall_time_seconds: `1.0126971669997147`
- uncompressed_solve_wall_time_seconds: `1.4603099579999252`
...
- available: `True`
- measured_wall_time_seconds: `1.0126971669997147`
- measured_shot_usage: `24576.0`
- precision_target: `0.005`
- achieved_error: `0.001093321739` Hartree
...
- session_id: `None`
- batch_id: `None`
- submission_wall_time_seconds: `0.00040508300025976496`
...
- iterations: `35`
- evaluations: `35`
- final_objective_energy: `-1.060098178191` Hartree
...
- sampled_solver_energy_mean: `-1.058826627008` Hartree
- sampled_solver_energy_std: `0.000212431294` Hartree
- sampled_electronic_energy_mean: `-8.855046195785` Hartree
- sampled_total_energy_mean: `-7.862838925310` Hartree
- standard_error: `0.000122647265` Hartree
- confidence_interval_low: `-1.059067015647` Hartree
- confidence_interval_high: `-1.058586238369` Hartree
...
- Timestamp: `2026-04-12T00:35:58.603924+00:00`
- Wall time (s): `2.7518692089997785`
- Git commit: `None`
...
- Workspace fingerprint: `89d48a5b7aa5ebec3a7ae75b62a1836a45e4d16364bac3f56c129d030b2d9e2f`
...
- Seed: `109`
- Source config: `configs/lih_active_shot_runtime_ready_compressed.yaml`

## Artifacts

- result.json: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/result.json`
- exact_result.json: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/exact_result.json`
- report.md: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/report.md`
- resolved_config.yaml: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/resolved_config.yaml`
- run.log: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/run.log`
- calibration.json: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/calibration.json`
- calibration_report.md: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/calibration_report.md`
- runtime_submission.json: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/runtime_submission.json`
- qcschema.json: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/qcschema.json`
- result.h5: `/Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/result.h5`

## Log Summary

- Loading config from configs/lih_active_shot_runtime_ready_compressed.yaml
...
- Writing exact baseline artifact to /Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/exact_result.json
- Collected repeated shot-based sampling statistics
- Computed compressed-vs-uncompressed execution comparison
- Computed empirical calibration: wall_time=1.013s, measured_cost=24576.0
- Runtime submission attempt recorded: account_not_found
- Writing JSON result to /Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/result.json
- Writing Markdown report to /Users/a0000/QCchem/artifacts/lih_active_shot_runtime_ready_compressed/report.md
- Run completed
