...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_cutoff_2', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 1.7763568394002505e-15, 'relative_error': 1.833421215111056e-16, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.15329658400150947, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 49, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
- trust_judgment: `{'verification_status': 'exploratory', 'module_origin': 'exploratory', 'hardware_verified': False, 'hardware_evidence_tier': None, 'verification_notes': ['validation_scope=lattice_qed_finite_cutoff_exact_gate'], 'scientific_risk_notes': ['Lattice-QED execution uses a finite cutoff real-space field Hamiltonian.', 'Exact baselines compare against the discretized finite cutoff model, not continuum chemistry.', 'Continuum, gauge-cutoff, and grid-convergence claims require explicit follow-up studies.', 'Exploratory finite-cutoff compact-U(1) lattice-QED Hamiltonian.', 'Exact baselines compare against this discretized Hamiltonian, not continuum chemistry.', 'Gauge links use binary padding with encoded dimension 8.', 'Pauli decomposition was materialized for this finite Hamiltonian.']}`
- provenance_timestamp: `2026-05-24T02:37:15.460295+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2`
...
- Scientific Risk Notes: `['Lattice-QED execution uses a finite cutoff real-space field Hamiltonian.', 'Exact baselines compare against the discretized finite cutoff model, not continuum chemistry.', 'Continuum, gauge-cutoff, and grid-convergence claims require explicit follow-up studies.', 'Exploratory finite-cutoff compact-U(1) lattice-QED Hamiltonian.', 'Exact baselines compare against this discretized Hamiltonian, not continuum chemistry.', 'Gauge links use binary padding with encoded dimension 8.', 'Pauli decomposition was materialized for this finite Hamiltonian.']`
...
- relative_error: `1.833421215111056e-16`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/quantum_evidence.json`
- sidecar_sha256: `019852a810ee6008c75a8951742df03396bbea321bdd3e0200ed47ca0d752d86`
- pauli_term_count: `122`
- measurement_group_count: `49`
- energy_contribution_sum: `-9.688754688554` Hartree
- coefficient_l1_norm: `274.5833333333334`
- groups_sha256: `094e37b86ee77d04fa3888a2be207863ea6ad93d6aff3ec13d9dd6f489593f7d`
- counts_available: `True`
- counts_source: `statevector_sampler_from_final_state`
- counts_sha256: `fa86ab4c2ffc014e1e7e85aca0d526b512a4f05dbaff7212a09621965611f879`
- shots_per_group: `4096`
- hamiltonian_variance: `0.0`
- ground_state_overlap: `1.0000000000000009`
- dominant_configurations: `[{'bitstring': '1001010', 'probability': 0.2848137078497786}, {'bitstring': '0110010', 'probability': 0.28481370784977184}, {'bitstring': '0011011', 'probability': 0.21518629215022586}, {'bitstring': '1100001', 'probability': 0.21518629215022406}, {'bitstring': '0101010', 'probability': 2.557526091475111e-29}, {'bitstring': '1010010', 'probability': 1.493009713865213e-29}, {'bitstring': '0010011', 'probability': 4.5926315934745064e-32}, {'bitstring': '1010011', 'probability': 4.1217317863955064e-32}]`
...
- qft_constraints: `{'available': True, 'gauss_law_tolerance': 1e-08, 'target_charge_sector': 'neutral', 'reference_basis_index': 27, 'reference_state_gauss_law_residuals': [0.0, 0.0], 'reference_state_max_abs_gauss_law': 0.0}`
- resources: `{'num_qubits': 7, 'raw_num_qubits': 7, 'qubit_term_count': 122, 'raw_qubit_term_count': 122, 'circuit_depth': None, 'two_qubit_gate_count': None, 'operation_counts': {}}`
...
- Qubit Hamiltonian terms: `122`
- Raw qubit count: `7`
- Raw qubit Hamiltonian terms: `122`
...
- matter_mode_count: `4`
- gauge_group: `u1`
- gauge_electric_cutoff: `2`
- gauge_coupling: `1.0`
- total_qubits: `7`
- target_electrons: `2`
- term_counts_by_sector: `{'onsite': 5, 'external_point_charge': 0, 'hopping': 80, 'density_coulomb': 0, 'electric': 6, 'magnetic_plaquette': 0, 'gauss_law_penalty': 32, 'particle_number_penalty': 7, 'padding_penalty': 8}`
...
- gauss_law_generators: `[{'pauli_term_count': 8, 'pauli_materialized': True, 'frobenius_norm': 14.966629547095765, 'hermitian': True, 'site_index': 0, 'target_charge': 0.0, 'diagonal_min': -3.0, 'diagonal_max': 3.0}, {'pauli_term_count': 8, 'pauli_materialized': True, 'frobenius_norm': 14.966629547095765, 'hermitian': True, 'site_index': 1, 'target_charge': 0.0, 'diagonal_min': -3.0, 'diagonal_max': 3.0}]`
...
- physical_sector: `{'enumerated': True, 'physical_sector_dimension': 6, 'target_charge_sector': 'neutral', 'max_sector_enumeration_qubits': 10, 'basis_indices_preview': [27, 42, 50, 74, 82, 97], 'reference_basis_index': 27, 'basis_index_count': 6, 'basis_hash': '41673fb28af7fff8f8194460278d962fc5554032937442841410cbb9506c67c1', 'basis_indices': [27, 42, 50, 74, 82, 97], 'padding_state_rejection_count': 48, 'tolerance': 1e-08, 'estimated_full_dimension': 128, 'skipped_reason': None}`
- gauge_invariant_ansatz: `{'kind': 'gauss_law_preserving', 'generator_policy': 'gauge_invariant_hopping', 'selected_generator_count': 1, 'selected_generators': [{'sector': 'hopping', 'selected': True, 'commutes_with_all_gauss_law_generators': True, 'max_commutator_norm': 0.0, 'commutator_norms': [0.0, 0.0], 'pauli_term_count': 80, 'pauli_materialized': True, 'skipped_reason': None}], 'commutator_checks': [{'sector': 'hopping', 'selected': True, 'commutes_with_all_gauss_law_generators': True, 'max_commutator_norm': 0.0, 'commutator_norms': [0.0, 0.0], 'pauli_term_count': 80, 'pauli_materialized': True, 'skipped_reason': None}]}`
- constraint_expectations: `{'available': True, 'gauss_law_tolerance': 1e-08, 'target_charge_sector': 'neutral', 'reference_basis_index': 27, 'reference_state_gauss_law_residuals': [0.0, 0.0], 'reference_state_max_abs_gauss_law': 0.0}`
...
- basis_hash: `41673fb28af7fff8f8194460278d962fc5554032937442841410cbb9506c67c1`
- basis_index_count: `6`
...
- term_count: `122`
- group_count: `49`
- estimated_shot_cost: `490000.0`
- runtime_precision_target: `0.01`
- uncompressed_group_count: `49`
- uncompressed_estimated_shot_cost: `490000.0`
...
- available: `True`
- measured_wall_time_seconds: `0.014303749994724058`
- measured_shot_usage: `None`
- precision_target: `0.01`
- achieved_error: `0.000000000000` Hartree
- estimated_measurement_cost: `490000.0`
...
- Timestamp: `2026-05-24T02:37:15.460295+00:00`
- Wall time (s): `0.15329658400150947`
...
- Workspace fingerprint: `e03732e0b674f11a4bfb73cf98a43765f6ec065953a5676d7711a887bf44d979`
...
- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Constructed lattice-QED Hamiltonian: sites=2, links=1, qubits=7
- Prepared measurement plan: groups=49, cost=490000
- Skipping backend construction for solver: exact
- Running solver: exact
- Computing exact spectrum for 1 states
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/exact_result.json
- Computed empirical calibration: wall_time=0.014s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_2/report.md
- Run completed
