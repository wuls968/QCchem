...
- headline_total_energy: `-9.619639351238` Hartree
- headline_correlation_energy: `None`
- headline_absolute_error: `0.000000000000` Hartree
- comparison_target: `exact_baseline`
- active_space_metadata: `{'field_model': 'lattice_qed_minimal_coupling', 'grid_shape': [2], 'matter_modes': 4, 'gauge_links': 2}`
- runtime_backend: `None`
- runtime_job_id: `None`

## Evidence Summary

- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_2site_periodic', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 4.263256414560601e-14, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 4.263256414560601e-14, 'relative_error': 3.932442579301422e-15, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.42314341699238867, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-24T02:37:17.483369+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic`
...
- electronic_energy: `-10.841242633778` Hartree
...
- total_energy: `-9.619639351238` Hartree
- hf_reference_energy: `None`
- solver_energy: `-10.841242633778` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-10.841242633778` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
...
- solver_hamiltonian_energy: `-10.841242633778` Hartree
- electronic_energy: `-10.841242633778` Hartree
- total_energy: `-9.619639351237` Hartree

## Benchmark

- exact_available: `True`
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-10.841242633778` Hartree
- exact_total_energy: `-9.619639351237` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `3.932442579301422e-15`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/quantum_evidence.json`
- sidecar_sha256: `1008840f45f4425e0e3d67760b3df0a876c6a8bde95617262dcaada249881961`
- pauli_term_count: `101`
- measurement_group_count: `25`
- energy_contribution_sum: `-10.841242633778` Hartree
- coefficient_l1_norm: `287.11111111111114`
- groups_sha256: `f286dfc21fb45c79fbb20acbc8145f6fa3566e6b7f4b7205a378c9f31bc2a707`
- counts_available: `True`
- counts_source: `statevector_sampler_from_final_state`
- counts_sha256: `3df2cd7114bbb70b1f201ba4a304839e5d44cfca7b177a01927eca515189e13b`
- shots_per_group: `4096`
- hamiltonian_variance: `4.263256414560601e-14`
- ground_state_overlap: `1.0`
- dominant_configurations: `[{'bitstring': '01100101', 'probability': 0.2068235876456572}, {'bitstring': '10010101', 'probability': 0.20682358764565523}, {'bitstring': '11000001', 'probability': 0.11906689850673957}, {'bitstring': '00110100', 'probability': 0.11906689850673934}, {'bitstring': '11000110', 'probability': 0.11906689850673846}, {'bitstring': '00111001', 'probability': 0.11906689850673818}, {'bitstring': '01100000', 'probability': 0.02752130767043331}, {'bitstring': '10010000', 'probability': 0.027521307670433245}]`
...
- Active space metadata: `{'field_model': 'lattice_qed_minimal_coupling', 'grid_shape': [2], 'matter_modes': 4, 'gauge_links': 2}`
...
- Qubit Hamiltonian terms: `101`
- Raw qubit count: `8`
- Raw qubit Hamiltonian terms: `101`
...
- total_qubits: `8`
- target_electrons: `2`
- term_counts_by_sector: `{'onsite': 5, 'external_point_charge': 0, 'hopping': 64, 'density_coulomb': 0, 'electric': 3, 'magnetic_plaquette': 0, 'gauss_law_penalty': 25, 'particle_number_penalty': 7, 'padding_penalty': 7}`
...
- gauss_law_generators: `[{'pauli_term_count': 6, 'pauli_materialized': True, 'frobenius_norm': 19.595917942265423, 'hermitian': True, 'site_index': 0, 'target_charge': 0.0, 'diagonal_min': -3.0, 'diagonal_max': 3.0}, {'pauli_term_count': 6, 'pauli_materialized': True, 'frobenius_norm': 19.595917942265423, 'hermitian': True, 'site_index': 1, 'target_charge': 0.0, 'diagonal_min': -3.0, 'diagonal_max': 3.0}]`
...
- physical_sector: `{'enumerated': True, 'physical_sector_dimension': 16, 'target_charge_sector': 'neutral', 'max_sector_enumeration_qubits': 10, 'basis_indices_preview': [52, 57, 80, 85, 90, 96, 101, 106, 144, 149, 154, 160, 165, 170, 193, 198], 'reference_basis_index': 52, 'basis_index_count': 16, 'basis_hash': '8a68bd375cf16b5675cbea3496a7d1e51c608fe8497adfcda6992bd31db929cb', 'basis_indices': [52, 57, 80, 85, 90, 96, 101, 106, 144, 149, 154, 160, 165, 170, 193, 198], 'padding_state_rejection_count': 112, 'tolerance': 1e-08, 'estimated_full_dimension': 256, 'skipped_reason': None}`
- gauge_invariant_ansatz: `{'kind': 'gauss_law_preserving', 'generator_policy': 'gauge_invariant_hopping', 'selected_generator_count': 1, 'selected_generators': [{'sector': 'hopping', 'selected': True, 'commutes_with_all_gauss_law_generators': True, 'max_commutator_norm': 0.0, 'commutator_norms': [0.0, 0.0], 'pauli_term_count': 64, 'pauli_materialized': True, 'skipped_reason': None}], 'commutator_checks': [{'sector': 'hopping', 'selected': True, 'commutes_with_all_gauss_law_generators': True, 'max_commutator_norm': 0.0, 'commutator_norms': [0.0, 0.0], 'pauli_term_count': 64, 'pauli_materialized': True, 'skipped_reason': None}]}`
- constraint_expectations: `{'available': True, 'gauss_law_tolerance': 1e-08, 'target_charge_sector': 'neutral', 'reference_basis_index': 52, 'reference_state_gauss_law_residuals': [0.0, 0.0], 'reference_state_max_abs_gauss_law': 0.0}`
...
- basis_hash: `8a68bd375cf16b5675cbea3496a7d1e51c608fe8497adfcda6992bd31db929cb`
- basis_index_count: `16`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `2.6752337902280486e-11`
- threshold_hartree: `0.0016`
...
- available: `True`
- measured_wall_time_seconds: `0.26756712500355206`
...
- Timestamp: `2026-05-24T02:37:17.483369+00:00`
- Wall time (s): `0.42314341699238867`
...
- Workspace fingerprint: `9aac19b18c4e560403768d94fc870fd59b52026eae3ec2eb33065e027c9270bf`
...
- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Constructed lattice-QED Hamiltonian: sites=2, links=2, qubits=8
...
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/exact_result.json
- Computed empirical calibration: wall_time=0.268s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_2site_periodic/report.md
- Run completed
