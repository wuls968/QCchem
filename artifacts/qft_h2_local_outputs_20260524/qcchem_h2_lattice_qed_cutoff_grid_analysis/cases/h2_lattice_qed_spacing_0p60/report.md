...
- headline_total_energy: `-9.566537409920` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_spacing_0p60', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 1.7763568394002505e-14, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 1.7763568394002505e-14, 'relative_error': 1.6465829377268832e-15, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.10655441699782386, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-24T02:37:15.574046+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60`
...
- electronic_energy: `-10.788140692460` Hartree
...
- total_energy: `-9.566537409920` Hartree
- hf_reference_energy: `None`
- solver_energy: `-10.788140692460` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-10.788140692460` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
...
- solver_hamiltonian_energy: `-10.788140692460` Hartree
- electronic_energy: `-10.788140692460` Hartree
- total_energy: `-9.566537409920` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-10.788140692460` Hartree
- exact_total_energy: `-9.566537409920` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `1.6465829377268832e-15`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/quantum_evidence.json`
- sidecar_sha256: `4f617fd9ce3b1b4ffb573fd257beae3ee28f911b8b3acbf1546c873a81c6dbf2`
- pauli_term_count: `54`
- measurement_group_count: `25`
- energy_contribution_sum: `-10.788140692460` Hartree
- coefficient_l1_norm: `155.55555555555557`
...
- counts_sha256: `cfd05490331fb33e1b5f27f6d083df5ca7c5219f8b83baeec1582e09a3de5dcc`
- shots_per_group: `4096`
- hamiltonian_variance: `1.4210854715202004e-14`
- ground_state_overlap: `0.9999999999999996`
- dominant_configurations: `[{'bitstring': '100101', 'probability': 0.2724094248739734}, {'bitstring': '011001', 'probability': 0.2724094248739717}, {'bitstring': '001110', 'probability': 0.22759057512602748}, {'bitstring': '110000', 'probability': 0.22759057512602718}, {'bitstring': '101001', 'probability': 7.015974240566745e-31}, {'bitstring': '010101', 'probability': 1.6539473449503316e-31}, {'bitstring': '111001', 'probability': 3.056798029622688e-32}, {'bitstring': '011101', 'probability': 2.9513895202334785e-32}]`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `1.1146807459283536e-11`
- threshold_hartree: `0.0016`
...
- available: `True`
- measured_wall_time_seconds: `0.0019547499978216365`
...
- Timestamp: `2026-05-24T02:37:15.574046+00:00`
- Wall time (s): `0.10655441699782386`
...
- Workspace fingerprint: `c1ab0a448dec766dec965aeaef886651427de4d6233152cafe08a6ca571ab744`
...
- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/exact_result.json
- Computed empirical calibration: wall_time=0.002s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_spacing_0p60/report.md
- Run completed
