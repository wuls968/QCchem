...
- headline_total_energy: `-10.808493996312` Hartree
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_softening_0p25', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 1.0658141036401503e-14, 'relative_error': 8.816572521003661e-16, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.11105258300085552, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-24T02:37:15.694238+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25`
...
- electronic_energy: `-12.088757860280` Hartree
- nuclear_repulsion_energy: `1.280263863968` Hartree
...
- total_energy: `-10.808493996312` Hartree
- hf_reference_energy: `None`
- solver_energy: `-12.088757860280` Hartree (raw solver-Hamiltonian energy, before QCchem constant-shift correction)
- exact_ground_energy: `-12.088757860280` Hartree (raw exact baseline in the same solver-Hamiltonian convention)
...
- solver_hamiltonian_energy: `-12.088757860280` Hartree
- electronic_energy: `-12.088757860280` Hartree
- total_energy: `-10.808493996312` Hartree
...
- comparison_target: `exact_baseline`
- exact_electronic_energy: `-12.088757860280` Hartree
- exact_total_energy: `-10.808493996312` Hartree
- absolute_error: `0.000000000000` Hartree
- relative_error: `8.816572521003661e-16`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/quantum_evidence.json`
- sidecar_sha256: `7aadd8454a0cadd3a40350a5dafe263f16ba86647660762597565a198cc548e1`
- pauli_term_count: `54`
- measurement_group_count: `25`
- energy_contribution_sum: `-12.088757860280` Hartree
...
- counts_sha256: `943b9c2c1306e62cc63e1c1b68e4a2e5d6aa9e31e21eb41d0578fa6e6ccfa2c4`
- shots_per_group: `4096`
- hamiltonian_variance: `0.0`
- ground_state_overlap: `1.0000000000000009`
- dominant_configurations: `[{'bitstring': '011001', 'probability': 0.28481370784977833}, {'bitstring': '100101', 'probability': 0.28481370784977206}, {'bitstring': '110000', 'probability': 0.21518629215022586}, {'bitstring': '001110', 'probability': 0.21518629215022406}, {'bitstring': '101001', 'probability': 7.715989223784154e-29}, {'bitstring': '010101', 'probability': 5.878704375162728e-29}, {'bitstring': '111000', 'probability': 1.4264726430119347e-32}, {'bitstring': '000011', 'probability': 1.312317563746651e-32}]`
...
- qft_constraints: `{'available': True, 'gauss_law_tolerance': 1e-08, 'target_charge_sector': 'neutral', 'reference_basis_index': 14, 'reference_state_gauss_law_residuals': [0.0, 0.0], 'reference_state_max_abs_gauss_law': 0.0}`
...
- Hamiltonian constants: `{'nuclear_repulsion_energy': 1.280263863968432}`
...
- removed_orbitals: `[]`
- hamiltonian_constants: `{'nuclear_repulsion_energy': 1.280263863968432}`
- constant_energy_correction: `0.000000000000` Hartree
- nuclear_repulsion_energy: `1.280263863968` Hartree
- external_point_charge_nuclear_interaction_energy: `0.000000000000` Hartree
- boundary_embedding_constant_energy: `0.000000000000` Hartree
- total_constant_correction: `1.280263863968` Hartree
- energy_formula: `total_energy = solver_energy + constant_energy_correction + nuclear_repulsion_energy + external_point_charge_nuclear_interaction_energy + boundary_embedding_constant_energy; electronic_energy = solver_energy + constant_energy_correction`
...
- available: `True`
- measured_wall_time_seconds: `0.0018469580099917948`
...
- Timestamp: `2026-05-24T02:37:15.694238+00:00`
- Wall time (s): `0.11105258300085552`
...
- Workspace fingerprint: `a2da3e309da12075d90abc0d790eb556d55d17cec9e2e87b10b63bde82e5b90c`
...
- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/exact_result.json
- Computed empirical calibration: wall_time=0.002s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_softening_0p25/report.md
- Run completed
