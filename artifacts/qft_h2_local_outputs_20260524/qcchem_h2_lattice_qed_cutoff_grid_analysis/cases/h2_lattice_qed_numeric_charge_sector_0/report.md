# QCchem Report: H2-lattice-QED-sector-audit
...
- molecule: `H2-lattice-QED-sector-audit`
...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_numeric_charge_sector_0', 'molecule_name': 'H2-lattice-QED-sector-audit', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
- primary_scientific_claim: `H2-lattice-QED-sector-audit lattice-QED result is gauge-audited finite-cutoff evidence compared against exact_baseline.`
...
- primary_error_metric: `{'metric_kind': 'absolute_error_hartree', 'value': 8.881784197001252e-15, 'units': 'Hartree', 'threshold': 1e-09, 'comparison_target': 'exact_baseline'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 8.881784197001252e-15, 'relative_error': 9.167106075555263e-16, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.11627166600374039, 'shots': None, 'measurement_strategy': 'lattice_qed_sector_audit', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-24T02:37:17.610161+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0`
...
- relative_error: `9.167106075555263e-16`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/quantum_evidence.json`
- sidecar_sha256: `715134f44c96cc376adfb4caa50257a1cf2fce6c124b8f5502b655c67031c398`
- pauli_term_count: `54`
- measurement_group_count: `25`
- energy_contribution_sum: `-9.688754688554` Hartree
- coefficient_l1_norm: `153.55555555555554`
- groups_sha256: `85cc424d342fb5f3648bb5defb39785ed7b04a99bf0fcb34043073e2cbd54ba1`
- counts_available: `True`
- counts_source: `statevector_sampler_from_final_state`
- counts_sha256: `e8711ec1dd9f55cee4a7c366605a221608e12a2ee8b02add82d724f3ab6b880a`
- shots_per_group: `4096`
- hamiltonian_variance: `7.105427357601002e-14`
- ground_state_overlap: `0.9999999999999989`
- dominant_configurations: `[{'bitstring': '100101', 'probability': 0.2848137078497757}, {'bitstring': '011001', 'probability': 0.2848137078497734}, {'bitstring': '001110', 'probability': 0.21518629215022544}, {'bitstring': '110000', 'probability': 0.21518629215022483}, {'bitstring': '010101', 'probability': 4.1028092055457956e-30}, {'bitstring': '101001', 'probability': 2.1045828655407613e-30}, {'bitstring': '111111', 'probability': 2.623323028350442e-32}, {'bitstring': '110101', 'probability': 1.986142389709945e-32}]`
...
- Raw qubit count: `6`
- Raw qubit Hamiltonian terms: `54`
...
- total_qubits: `6`
- target_electrons: `2`
- term_counts_by_sector: `{'onsite': 5, 'external_point_charge': 0, 'hopping': 32, 'density_coulomb': 0, 'electric': 2, 'magnetic_plaquette': 0, 'gauss_law_penalty': 12, 'particle_number_penalty': 7, 'padding_penalty': 4}`
- constraints: `{'gauss_law_penalty': 10.0, 'particle_number_penalty': 10.0, 'padding_penalty': 50.0, 'enforce_physical_sector': True, 'target_charge_sector': '0', 'gauss_law_tolerance': 1e-08, 'max_sector_enumeration_qubits': 8}`
...
- constraint_expectations: `{'available': True, 'gauss_law_tolerance': 1e-08, 'target_charge_sector': '0', 'reference_basis_index': 14, 'reference_state_gauss_law_residuals': [0.0, 0.0], 'reference_state_max_abs_gauss_law': 0.0}`
...
- meets_chemical_accuracy: `True`
- absolute_error_hartree: `0.000000000000` Hartree
- absolute_error_kcal_mol: `5.573403729641768e-12`
- threshold_hartree: `0.0016`
...
- notes: `["Measurement groups estimated with strategy 'lattice_qed_sector_audit'.", 'Per-group shot estimate derived from precision target 0.01.', 'Measurement planning reflects the uncompressed execution path.']`
...
- available: `True`
- measured_wall_time_seconds: `0.003575916009140201`
...
- Timestamp: `2026-05-24T02:37:17.610161+00:00`
- Wall time (s): `0.11627166600374039`
...
- Workspace fingerprint: `f6d76c736c6b7d13982cc28cea01d9c3a6221573b52aa059b3f167cbb0ac96a9`
...
- Seed: `2028`
- Source config: `./configs/exploratory/h2_lattice_qed_sector_audit.yaml`

## Artifacts

- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`

## Log Summary

- Loading config from ./configs/exploratory/h2_lattice_qed_sector_audit.yaml
...
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/exact_result.json
- Computed empirical calibration: wall_time=0.004s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_numeric_charge_sector_0/report.md
- Run completed
