...
- result_identity: `{'artifact_kind': 'run', 'artifact_name': 'h2_lattice_qed_cutoff_1', 'molecule_name': 'H2-lattice-QED-exact', 'basis': 'real_space_lattice', 'backend_kind': 'statevector', 'mapping_kind': 'lattice_qed:jordan_wigner', 'field_model_kind': 'lattice_qed'}`
...
- comparison_evidence: `{'comparison_target': 'exact_baseline', 'absolute_error': 1.0658141036401503e-14, 'relative_error': 1.1000527290666323e-15, 'statistical_error': None, 'baseline_strength': 'strong', 'compressed_vs_uncompressed': None}`

## Proof

- execution_evidence: `{'wall_time_seconds': 0.10376470799383242, 'shots': None, 'measurement_strategy': 'lattice_qed_exact', 'measurement_group_count': 25, 'measured_shot_usage': None, 'runtime_backend': None, 'runtime_job_id': None, 'field_model_kind': 'lattice_qed'}`
...
- provenance_timestamp: `2026-05-24T02:37:15.292687+00:00`
- runtime_job_id: `None`
- artifact_root: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1`
...
- relative_error: `1.1000527290666323e-15`
- statistical_error: `None`
...
- sidecar_path: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/quantum_evidence.json`
- sidecar_sha256: `8c21568c7fe3101df72ed610724dd5a02112d6b6c8a4f9ed291346617797e970`
- pauli_term_count: `54`
- measurement_group_count: `25`
- energy_contribution_sum: `-9.688754688555` Hartree
...
- counts_sha256: `04c3f9773644cc6e0dd6ab1cf708409f123e049086ad1ba5da10bbb9c661d408`
- shots_per_group: `4096`
- hamiltonian_variance: `4.263256414560601e-14`
- ground_state_overlap: `0.9999999999999993`
- dominant_configurations: `[{'bitstring': '011001', 'probability': 0.28481370784977467}, {'bitstring': '100101', 'probability': 0.28481370784977467}, {'bitstring': '110000', 'probability': 0.21518629215022528}, {'bitstring': '001110', 'probability': 0.21518629215022508}, {'bitstring': '010101', 'probability': 1.4911440900507165e-31}, {'bitstring': '101001', 'probability': 9.75430230337828e-32}, {'bitstring': '000011', 'probability': 5.181569330557836e-32}, {'bitstring': '111110', 'probability': 9.291336841449397e-33}]`
...
- available: `True`
- measured_wall_time_seconds: `0.0027317920030327514`
...
- Timestamp: `2026-05-24T02:37:15.292687+00:00`
- Wall time (s): `0.10376470799383242`
...
- Workspace fingerprint: `ad5fc5ffa31da4bab422669fc1c10ba3439cf75cead957c14cccb8d8252c0e63`
...
- result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/result.json`
- exact_result.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/exact_result.json`
- report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/report.md`
- resolved_config.yaml: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/resolved_config.yaml`
- run.log: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/run.log`
- calibration.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/calibration.json`
- calibration_report.md: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/calibration_report.md`
- runtime_submission.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/runtime_submission.json`
- quantum_evidence.json: `/tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/quantum_evidence.json`
- qcschema.json: `None`
- result.h5: `None`
...
- Writing exact baseline artifact to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/exact_result.json
- Computed empirical calibration: wall_time=0.003s, measured_cost=None
- Writing JSON result to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/result.json
- Writing Markdown report to /tmp/qcchem_h2_lattice_qed_cutoff_grid_analysis/cases/h2_lattice_qed_cutoff_1/report.md
- Run completed
